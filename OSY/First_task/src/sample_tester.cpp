...
{
  if(m_MinPos!=g_Data.size()){
    printf("not enough send min\n");
  }
  if(m_MinDone != g_Data . size() ){
    printf("not enough completed tasks min\n");

  }
  if(m_CntPos!=g_Data.size()){
    printf("not enough send cnt\n");
  }
  if(m_CntDone!=g_Data.size()){
    printf("not enough completed tasks cnt\n");
  }
